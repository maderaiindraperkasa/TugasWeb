...
<html lang="en">
	...
	<div class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="#	" class="navbar-brand">Roti Rasa</a>
			...
			<div class="collapse navbar-collapse">				
				<ul class="nav navbar-nav navbar-right">
					<li><a class="dropdown-toggle" data-toggle="dropdown" role="button" href="#">Welcome, <?php echo $_SESSION['username']  ?>&nbsp&nbsp<span class="glyphicon glyphicon-user"></span></a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="col-md-2">
			<div class="row"> 
				<div class="col-xs-6 col-md-12">
					<a class="thumbnail">
						<img class="img img-rounded" src="material/images/profil.png">
					</a>
				</div>
			</div>
          ...
          <!--<a href="#">
            ...
            <span class="pull-right-container">
              <span class="fa fa-angle-left pull-right"></span>            </span>          </a>
				...
				<li><a href="?dorayaki=barang"><span class="glyphicon glyphicon-tasks"> Roti Rasa</a></li>
				<li><a href="?dorayaki=supplier"><span class="glyphicon glyphicon-user"> Pemasok Roti</a></li>
	...
	?>
		<ul class="nav nav-pills nav-stacked" style="width:180px;">
				...
				<li><a href="?dorayaki=konfirmasi1"><span class="glyphicon glyphicon-list-alt"> Konfirmasi Pemesanan</a></li>
				<li><a href="logout.php"><span class="glyphicon glyphicon-log-out"> Logout</a></li>
		</ul>
	<?php } ?>		
		</div>
