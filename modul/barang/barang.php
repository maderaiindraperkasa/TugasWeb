...
switch($act){
	...
	echo"<h3 ><span class='glyphicon glyphicon-tasks'></span> Informasi Roti</h3>
	<input type=button class='btn btn-info col-md-2'value='+ Tambah Roti' onclick=\"window.location.href='?dorayaki=barang&act=input';\"><br><br>
	";
?>

<?php 
$periksa=mysqli_query($conn,"select * from barang where stok_barang <=10");
...
?>
	<table class="table table-hover">
		<thead>
				...
				<th class="col-md-1">Nama Roti</th>
				<th class="col-md-4">Varian Rasa</th>
				<th class="col-md-3">Stok Roti</th>
...
<?php
	...
	case "input":
	echo"<h2 class='head'>Tambah Roti</h2>
	<form method='POST' action='$aksi?dorayaki=barang&act=input'>
		<div class='form-group'>
			<div class='col-sm-5'>
			<label for='name'>Nama Roti</label>
			<input type='text' class='form-control' id='kode' placeholder='Nama Roti' name='kode' required />
			</div>
		</div>
		<div class='form-group'>
			<div class='col-sm-5'>
			<label for='name'>Varian Rasa</label>
			<input type='text' class='form-control' id='nama' placeholder='Varian Rasa' name='nama' required />
			</div>
		</div>
		<div class='form-group'>
			<div class='col-sm-5' style='margin-top:20px;margin-bottom:20px;'>
			<label for='email'>Stok Roti</label>
			<input type='text' class='form-control' id='stok' placeholder='Stok Roti' name='stok' required />
			</div>
		</div>
		<div class='form-group'>
			<div class='col-sm-5' style='margin-top:20px;margin-bottom:20px;'>
			<label for='email'>Harga</label>
			<input type='text' class='form-control' id='rop' placeholder='Harga' name='rop' required />
			</div>
		</div>
		<div class='col-sm-12'>
	...
	<input type='hidden' name='kode_barang' value='$r[kode_barang]' size='15'>
		<div class='form-group'>
			...
			<label for='barang'>Nama Roti</label>
			<input type='text' class='form-control' id='nama' placeholder='Nama Roti' name='nama' value='$r[nama_barang]' required />
			</div>
		</div>
		<div class='form-group'>
			<div class='col-sm-5'>
			<label for='pengiriman'>Stok Roti</label>
			<input type='text' class='form-control' id='nama' placeholder='Stok Roti' name='stok' value='$r[stok_barang]' required />
			</div>
		</div>
		<div class='form-group'>
			<div class='col-sm-3'>
			<label for='pengiriman'>Harga</label>
			<input type='text' class='form-control' id='nama' placeholder='Harga' name='rop' value='$r[ROP]' required />
			</div>
		</div>";
	echo"
